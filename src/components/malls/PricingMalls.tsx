...
export default function PricingMalls() {
  return (
    <section id="pricing-malls" className="py-24 bg-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
            Impacto <span className="text-brand-secondary">Máximo</span>, Costo Cero
          </h3>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
            <div className="lg:w-2/3">
              <p className="text-2xl text-gray-300 mb-10 leading-relaxed font-medium">
                Digitalizamos tu mall sin comprometer el presupuesto comercial. Un modelo colaborativo que multiplica el valor de tu centro comercial mediante tecnología y data.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex gap-4 items-start bg-white/10 p-6 rounded-2xl shadow-sm border border-white/5">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-white mb-1">Sin Costos</h4>
                    <p className="text-gray-400">Implementación de la infraestructura digital sin pagos iniciales.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start bg-white/10 p-6 rounded-2xl shadow-sm border border-white/5">
                  <TrendingUp className="text-brand-primary h-8 w-8 flex-shrink-0" />
                  <div>
                    <h4 className="text-xl font-bold text-white mb-1">Crecimiento</h4>
                    <p className="text-gray-400">Potenciamos la afluencia y la retención del cliente en todos tus locales.</p>
                  </div>
                </div>
              </div>
            </div>
