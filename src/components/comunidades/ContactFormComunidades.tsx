...
export default function ContactFormComunidades() {
  ...
  return (
    <section id="contacto-comunidades" className="py-24 bg-gray-50 dark:bg-slate-900 border-t border-gray-100 dark:border-gray-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-extrabold text-slate-950 mb-6 leading-tight">
            Eleva tu comunidad a la red de beneficios de Condado.
          </h3>
          <p className="text-xl text-gray-600 dark:text-gray-400 font-medium">
            Déjanos tus datos y un representante de nuestro equipo te contactará para formalizar la alianza.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-4 uppercase tracking-wider">Nombre del Administrador</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-4 uppercase tracking-wider">Correo Electrónico</label>
                <div className="relative group">
                  <span className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 group-hover:text-brand-primary transition-colors">
                    <Mail size={20} />
                  </span>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-4 uppercase tracking-wider">WhatsApp de Contacto</label>
                <div className="relative group">
                  <span className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 group-hover:text-brand-primary transition-colors">
                    <Phone size={20} />
                  </span>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-4 uppercase tracking-wider">Nombre del Edificio / PH</label>
                <div className="relative group">
                  <span className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 group-hover:text-brand-primary transition-colors">
                    <Building size={20} />
                  </span>
                  <input
                    type="text"
                    placeholder="PH Condado del Rey, etc."
                    className="w-full pl-14 pr-6 py-5 rounded-[1.5rem] bg-gray-50 dark:bg-slate-900 border-2 border-transparent focus:border-brand-primary focus:bg-white dark:focus:bg-slate-950 transition-all outline-none text-lg font-medium shadow-sm active:scale-[0.99]"
                    required
                  />
                </div>
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-4 uppercase tracking-wider">¿En qué podemos ayudar a su comunidad?</label>
              <textarea
                rows={4}
                placeholder="Cuéntanos sobre los desafíos de tu edificio o comunidad..."
